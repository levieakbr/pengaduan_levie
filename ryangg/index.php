...
<table border="1" cellpadding="10" cellspacing="0"\>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>
                <a href="edit_aspirasi.php?aspiration_id=' . $row['aspiration_id'] . '">Edit</a> |
                <a href="delete_aspirasi.php?aspiration_id=' . $row['aspiration_id'] . '" onclick="return confirm(\'Are you sure you want to delete this aspiration?\')">Delete</a>'
                . '</td>';
            echo "</tr>";
        }
        ?>
